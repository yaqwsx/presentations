...
define i8* @thread1(i8* %arg) #0 {
  ...
  %3 = load i32* @data1, align 4
  %4 = add nsw i32 %3, 1
  store i32 %4, i32* @data1, align 4
  %5 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* @ma) #3
  %6 = load i32* @data2, align 4
  %7 = add nsw i32 %6, 1
  store i32 %7, i32* @data2, align 4
  %8 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* @ma) #3
  %9 = load i8** %1
  ret i8* %9
}
