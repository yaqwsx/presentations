...
.critedge:                                        ; preds = %.critedge, %0
  %5 = tail call i32 (...)* @__VERIFIER_nondet_int() #3
  %.off = add i32 %5, -2
  %6 = icmp ugt i32 %.off, 40
  br i1 %6, label %.critedge, label %7

; <label>:7                                       ; preds = %.critedge
  %8 = tail call i32 @pthread_mutex_lock(%union.pthread_mutex_t* @ma) #3
  %9 = load volatile i32* @data2, align 4, !tbaa !1
  %10 = add nsw i32 %9, %5
  store volatile i32 %10, i32* @data2, align 4, !tbaa !1
  %11 = tail call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* @ma) #3
  ret i8* undef
}
